...
// moving content down n0t overlapping
  ...
  className={`${
    fixed
      ...
      : "relative w-full"
  } bg-white rounded-[24px] sm:rounded-[41.5px] shadow-lg py-[clamp(10px,2vw,15px)] px-[clamp(8px,2vw,16px)] overflow-visible z-[9999]`}
>
      <style>
        {`
