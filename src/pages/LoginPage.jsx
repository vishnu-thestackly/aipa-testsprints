...
export default function LoginPage() {
  ...
  // ACCOUNT LOCKED
if (
  detail?.message?.toLowerCase().includes("account locked")
) {
    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 p-4 bg-black/40">
      <div className="rounded-xl p-5 md:p-6 w-full max-w-[380px] md:max-w-[450px] lg:w-[500px] lg:max-w-none lg:h-[270px] mx-4 lg:mx-0 text-center relative bg-white">
        ...
        <div className="flex justify-center mb-3 md:mb-4">
          <img className="w-10 h-10 md:w-12 md:h-12 mt-2" src={ClockCountdown} alt="" />
        </div>
        <h3 className="text-xl md:text-2xl font-semibold mb-2 text-[#4866F6]">Session Timeout</h3>
        <p className="text-[#8D97A9] text-xs md:text-sm mb-4 md:mb-5 px-2 md:px-0">
          For security reasons, your session has timed out. Please Log in again to access your account.
        </p>
        <button
          onClick={() => setShowSessionTimeout(false)}
      ...
      <div className="rounded-xl p-5 md:p-6 w-full max-w-[380px] md:max-w-[450px] lg:w-[500px] lg:max-w-none lg:h-[270px] mx-4 lg:mx-0 text-center relative bg-white">
        ...
        <div className="flex items-center gap-2 bg-red-50 border border-red-200 rounded-lg p-3 mb-4 w-full md:w-[380px] lg:w-[330px] mx-auto">
          ...
          <p className="text-[#ED3A3A] text-xs text-left">
            Account locked due to multiple failed login attempts. Please try again in {formatTime(lockoutTime)}
          </p>
        </div>
        <button
          onClick={() => setShowLockedPopup(false)}
      ...
      <div className="min-h-screen w-full bg-white lg:bg-[#F6F7FA] flex items-start lg:items-center justify-center p-0 lg:p-4">
        <div className="w-full max-w-6xl lg:w-[1000px] bg-transparent min-h-screen lg:min-h-[600px] lg:h-[600px] flex flex-col lg:flex-row items-center lg:items-center justify-start lg:justify-center gap-0 lg:gap-25">
          ...
          <div className="w-full lg:w-1/2 max-w-md md:max-w-lg flex flex-col justify-start lg:justify-center px-6 md:px-8 pt-12 pb-8 lg:px-0 lg:pt-0 lg:pb-0">
            ...
            <h1 className="text-[#4866F6] text-2xl md:text-3xl lg:text-2xl font-semibold mb-1 mt-5 lg:text-left">Log In</h1>
            <p className="text-[#8D97A9] text-sm md:text-base lg:text-sm mb-6 lg:mb-5 lg:text-left">Enter your details below to continue</p>

            <form onSubmit={handleLogin} className="space-y-4 md:space-y-5 lg:space-y-4">
              <div>
             ...
             ? 'border-red-400 focus:border-red-500 focus:ring-red-500'
              ...
              <div>
                <label className="text-gray-700 text-sm md:text-base lg:text-sm mb-1.5 block mt-5 lg:mt-0">Password</label>
                <div className="relative">
             ...
             ? 'border-red-400 focus:border-red-500 focus:ring-red-500'
              ...
              {captchaError && <p className="text-red-500 text-xs md:text-sm text-center mt-1">{captchaError}</p>}
  ...
  <span className="flex items-center justify-center leading-none">
    ...
    />
            ...
            <p className="text-gray-500 mt-3 text-sm md:text-base lg:text-sm text-center">
              ...
              <Link to="/signup" className="text-[#4F46E5] lg:mt-[10px] font-semibold underline">
                Sign Up
              </Link>
            </p>
          </div>
