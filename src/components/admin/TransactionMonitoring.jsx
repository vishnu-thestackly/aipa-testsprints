...
<div className="mx-4 md:mx-5 lg:mx-7 mt-5 mb-8 border border-[#D9D9D9] rounded-[12px] overflow-hidden bg-white"><div className="overflow-x-auto custom-scrollbar">
      ...
      <thead className="bg-[#F5F7FF] border-b-[2px] border-[#1695F9]">
        <tr>
          <th className="h-[62px] px-5 text-left text-[14px] font-medium text-[#3D3D3D]">SL No</th>
          <th className="h-[62px] px-5 text-left text-[14px] font-medium text-[#3D3D3D]">User Name</th>
          <th className="h-[62px] px-5 text-left text-[14px] font-medium text-[#3D3D3D]">Transaction ID</th>
          <th className="h-[62px] px-5 text-left text-[14px] font-medium text-[#3D3D3D]">Date</th>
          <th className="h-[62px] px-5 text-left text-[14px] font-medium text-[#3D3D3D]">Amount</th>
          <th className="h-[62px] px-5 text-left text-[14px] font-medium text-[#3D3D3D]">Status</th>
          <th className="h-[62px] px-5 text-left text-[14px] font-medium text-[#3D3D3D]">Subscription</th>
          <th className="h-[62px] px-5 text-center text-[14px] font-medium text-[#3D3D3D]">Action</th>
        </tr>
      </thead>
        ...
        {paginatedRows.map((r) => (
          <tr key={r.id} className="border-b border-[#E5E5E5]">
            ...
            <td className="h-[52px] px-5">
              <span className={`inline-flex items-center gap-2 px-4 h-[28px] rounded-full text-[14px] font-medium ${
                r.status === "Success"
...
<div className="w-full max-w-[820px] bg-white rounded-[28px] border-2 border-[#1695F9] p-4 sm:p-6 relative">      <button
