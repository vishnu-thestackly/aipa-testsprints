...
export default function Sidebar({ activeItem, setActiveItem, onLogout }) {
  ...
  const isSubscriptionActive = subscriptionMenus.includes(activeItem);

  return (
    <div className="hidden md:block">
      <div className="w-[100px] lg:w-[376px] bg-white p-3 lg:p-6 h-full overflow-y-auto scrollbar-hide">
  ...
  ${activeItem === "manage" ? "bg-[#4866F6]" : "hover:bg-[#4866F6]"}`}
            ...
            <button
              ...
              className={`w-[50px] lg:w-[302px] h-[44px] flex justify-center lg:justify-start gap-[10px] rounded-lg py-[10px] px-[10px] group items-center mt-3 cursor-pointer transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#4866F6] ${
                activeItem === "track" ? "bg-[#4866F6]" : "hover:bg-[#4866F6]"
              }`}
            >
              <svg
            ...
            <button
              ...
              className={`w-[50px] lg:w-[302px] h-[44px] flex justify-center lg:justify-start gap-[10px] rounded-lg py-[10px] px-[10px] group items-center mt-3 cursor-pointer transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#4866F6] ${
                activeItem === "usage" ? "bg-[#4866F6]" : "hover:bg-[#4866F6]"
              }`}
            >
              <svg
          ...
          <div className="mt-3">
            ...
            <button
                ...
                className={`w-[50px] lg:w-[302px] h-[44px] flex justify-center lg:justify-between items-center gap-[10px] rounded-lg py-[10px] px-[10px] group cursor-pointer transition-all duration-200 focus:outline-none 
                ${
                    subscriptionOpen
                        ? "bg-[#4866F6]"
                        : "hover:bg-[#4866F6]"
  ...
  <div className="ml-0 mt-2 flex flex-col gap-1">
    ...
    >
      <img
        ...
        alt="Transaction"
        className={`w-5 h-5 ${
          activeItem === "transaction" ? "brightness-0 invert" : ""
        }`}
      />
    ...
    >
      <img
        ...
        alt="Refund"
        className={`w-5 h-5 ${
          activeItem === "refund" ? "brightness-0 invert" : ""
        }`}
      />
    ...
    >
      <img
        ...
        alt="Payment Report"
        className={`w-5 h-5 ${
          activeItem === "payment" ? "brightness-0 invert" : ""
        }`}
      />
    ...
    <button
      type="button"
      onClick={() => setActiveItem("tracking")}
      className={`w-[270px] h-[40px] flex items-center gap-3 rounded-lg px-3 transition-all duration-200 group
      ${
        activeItem === "tracking"
          ? "bg-[#4866F6] text-white"
    ...
    >
      <img
        ...
        alt="Tracking"
        className={`w-5 h-5 ${
          activeItem === "tracking" ? "brightness-0 invert" : ""
        }`}
      />
  ...
  >
    Profile
          ...
          <div className="w-[100px] lg:w-[376px] flex mt-3 justify-center">
            ...
            <button
              className="hidden md:flex lg:hidden mt-8 md:mx-auto w-[50px] h-[44px] rounded-[10px] border border-[#FB0000] bg-[#FF000033] items-center justify-center cursor-pointer"
              onClick={onLogout}
            >
