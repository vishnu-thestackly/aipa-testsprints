...
import Subscriptiontrack from "../../assets/images/Subscriptiontrack.png"
...
import RefundImg from "../../assets/images/RefundImg.png"
...
export default function Sidebar({ activeItem, setActiveItem, onLogout }) {
 ...
 const subscriptionItems = [
  ...
  },
  {
    ...
    icon: Subscriptiontrack,
  },
];

  return (
    <div className="hidden md:block lg:block">
      <div className="hidden md:block md:w-[70px] lg:w-[376px] bg-white p-3 lg:p-6 h-full overflow-y-auto scrollbar-hide">
        <div className="w-full min-h-full flex flex-col justify-between items-center">
          <div>
            <button
              type="button"
              onClick={() => setActiveItem("dashboard")}
              className={`md:w-[50px] lg:w-[302px] flex-shrink-0 h-[44px] flex justify-center lg:justify-start gap-[10px] rounded-lg py-[10px] px-[10px] group items-center mt-3 cursor-pointer transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#4866F6]
                         ${activeItem === "dashboard" ? "bg-[#4866F6]" : "hover:bg-[#4866F6]"}`}>
              <svg
                aria-hidden="true"
                className={`w-[20px] h-[20.73px]
              ...
              <p
                className={`hidden lg:block ${activeItem === "dashboard"
                  ? "text-white"
                  : "text-[#586D93] group-hover:text-white"
                  }`}  >
                Dashboard
            ...
            <button
              ...
              className={`w-[50px] lg:w-[302px] h-[44px] flex justify-center lg:justify-start gap-[10px] rounded-lg py-[10px] px-[10px] group items-center mt-3 cursor-pointer transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#4866F6]
                       ${activeItem === "manage" ? "bg-[#4866F6]" : "hover:bg-[#4866F6]"}`}  >
              <svg
                className={`w-[20px] h-[20.73px] ${activeItem === "manage" ? "text-white" : "text-[#586D93] group-hover:text-white"}`}
                viewBox="0 0 24 24"
                fill="currentColor" >
            ...
            <button
              ...
              className={`w-[50px] lg:w-[302px] h-[44px] flex justify-center lg:justify-start gap-[10px] rounded-lg py-[10px] px-[10px] group items-center mt-3 cursor-pointer transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#4866F6] ${activeItem === "track" ? "bg-[#4866F6]" : "hover:bg-[#4866F6]"
                }`} >
              <svg
            ...
            <button
              type="button"
              onClick={() => setActiveItem("communication")}
              className={`w-[50px] lg:w-[302px] h-[44px] flex justify-center lg:justify-start gap-[10px] rounded-lg py-[10px] px-[10px] group items-center mt-3 cursor-pointer transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#4866F6] ${activeItem === "communication"
                ? "bg-[#4866F6]"
                : "hover:bg-[#4866F6]"
                }`}  >
              <svg
            ...
            <button
              ...
              className={`w-[50px] lg:w-[302px] h-[44px] flex justify-center lg:justify-start gap-[10px] rounded-lg py-[10px] px-[10px] group items-center mt-3 cursor-pointer transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#4866F6] ${activeItem === "usage" ? "bg-[#4866F6]" : "hover:bg-[#4866F6]"
                }`} >
              <svg
                className={`w-[20px] h-[20.73px] ${activeItem === "usage" ? "text-white" : "text-[#586D93] group-hover:text-white"}`}
                viewBox="0 0 24 24"
                fill="currentColor" >
            ...
            {/* sixth icon */}
            <button
              onClick={() => setActiveItem("configuration")}
              className={`w-[50px] lg:w-[302px] h-[44px] flex justify-center lg:justify-start gap-[10px] rounded-lg py-[10px] px-[10px] group items-center mt-3 cursor-pointer transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#4866F6] ${activeItem === "configuration"
                ? "bg-[#4866F6]"
                : "hover:bg-[#DCE4FF]"
                }`}  >
              <svg
                className={`w-[20px] h-[20.73px] ${activeItem === "configuration" ? "text-white" : "text-[#586D93] group-hover:text-white"}`}
                viewBox="0 0 24 24"
                fill="currentColor" >
            ...
            <div className="w-full mt-3">
              <button
                ...
                className={`w-[50px] lg:w-[302px] h-[44px]
    flex items-center justify-center lg:justify-between
    px-0 lg:px-[10px] rounded-lg group transition-all duration-300
...
${
  activeItem === "subscription"
    ? "brightness-0 invert"
    : "[filter:brightness(0)_saturate(100%)_invert(43%)_sepia(12%)_saturate(988%)_hue-rotate(184deg)_brightness(92%)_contrast(89%)]"
}
group-hover:brightness-0 group-hover:invert`}
                  />

                  <p
                    className={`hidden lg:block ${activeItem === "managesubscription"
                      ? "text-white"
                      : "text-[#586D93] group-hover:text-white"
                      }`}  >
                    Manage Subscription
  ...
  src={Downarrow}
  alt="arrow"
  className={`hidden lg:block w-[18px] h-[18px] transition-all duration-300
  ${openSubscription ? "rotate-180" : "rotate-0"}
  ${
    activeItem === "subscription"
      ? "brightness-0 invert"
      : "[filter:brightness(0)_saturate(100%)_invert(43%)_sepia(12%)_saturate(988%)_hue-rotate(184deg)_brightness(92%)_contrast(89%)]"
  ...
  <div className="mt-2 flex flex-col gap-1">
    {subscriptionItems.map((item) => (
      <button
        ...
        className={`w-[302px] h-[40px] flex items-center gap-[10px]
        px-[35px] rounded-lg transition-all duration-200
        ${
          activeItem === item.key
            ? "bg-[#4866F6] text-white"
            : "text-[#586D93] hover:bg-[#4866F6] hover:text-white"
      ...
      >
        ...
        <span>{item.label}</span>
            ...
            <button
              type="button"
              onClick={() => setActiveItem("adminProfile")}
              className={`w-[50px] lg:w-[302px] h-[44px] flex justify-center lg:justify-start gap-[10px] rounded-lg py-[10px] px-[10px] group items-center mt-3 cursor-pointer transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#4866F6]
          ...
          <div className="w-[100px] lg:w-[376px] flex mt-3 justify-center">

            {/* MOBILE & TABLET VIEW - ICON ONLY */}
            <button
              className="flex lg:hidden mt-8 mx-auto w-[50px] h-[44px] rounded-[10px] border border-[#FB0000] bg-[#FF000033] items-center justify-center cursor-pointer"
              onClick={() => navigate("/admin")}
            >
              <img src={SignOut} alt="logout" className="w-[18px] h-[18px]" />
            </button>

            {/* LAPTOP & DESKTOP VIEW - TEXT + ICON */}
            <button
              className="hidden lg:flex w-[292px] h-[44px] items-center justify-center gap-[10px] rounded-[10px] border border-[#FB0000] bg-[#FF000033] font-medium text-[18px] text-[#FF0000] cursor-pointer"
              onClick={() => navigate("/admin")}
            >
              <span>Logout</span>
              <img src={SignOut} alt="logout" className="w-[18px] h-[18px]" />
