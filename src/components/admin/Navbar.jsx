...
export default function Navbar({
  ...
  const getPageTitle = (key) => {
    const titles = {
      ...
      task_completion_analytics: "Task completion Analytics",
      error_fallback_analytics: "Error & Fallback Analytics",
      ai_performance_metrics: "AI Performance Metrics",
      usage_trend_analytics: "Usage Trend Analytics",
      optimization_recommendations: "Optimization Recommendations",
      user_engagement_insights: "User Engagement Insights",
      security_compliance: "Security & Compliance",
      security_dashboard: "Security Dashboard",
      security_testing_vulnerabilities: "Security Testing & Vulnerabilities",
      session_authentication: "Session & Authentication",
      data_protection_encryption: "Data Protection & Encrption",
    ...
    <div className="w-screen min-w-screen relative bg-white overflow-visible z-[9999]">
      ...
      <div className="md:hidden px-[20px] pt-[10px] pb-[14px]">
        ...
        <div className="flex justify-between items-center">
          ...
          <div onClick={() => setSidebarOpen(true)} className="w-[38px] h-[38px] min-[360px]:w-[40px] min-[360px]:h-[40px] min-[390px]:w-[42px] min-[390px]:h-[42px] rounded-full bg-[#F3F3F3] flex justify-center items-center cursor-pointer"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#586D93" strokeWidth="2">
...
"
        ...
        <div className="flex items-center gap-0 md:gap-0 lg:gap-2">
          ...
          <div className="flex justify-center items-center gap-2 md:gap-4 lg:gap-5 ml-0 md:ml-1 lg:ml-1 transition-transform duration-300 hover:scale-105 cursor-pointer">
            ...
            <div className="block md:hidden lg:block">
              ...
              <h2 className="w-auto font-bold text-[14px] lg:text-[24px] text-[#4866F6]">
                Personal
              </h2>

              <p className="font-medium text-[5px] lg:text-[8px] tracking-[0.5em] lg:tracking-[.73em] text-[#4866F6]">
                ASSISTANT
              </p>
          ...
          <div className="hidden md:flex lg:hidden items-center ml-[-25px]">
            {/* vertical line */}
            <div className="w-[60px] border-t border-[#CFCFCF] rotate-90 ml-[20px]"></div>

            <div
              onClick={() => setSidebarOpen(true)}
              className="ml-[5px] w-[40px] h-[40px] rounded-[20px] flex justify-center items-center bg-[#4866F626] text-[#4866F6] hover:bg-[#4866F6] hover:text-white cursor-pointer"
            >
          ...
          <div className="hidden lg:flex items-center ml-[-6px]">
            ...
            <div
              onClick={() => setSidebarOpen(true)}
              className="ml-[95px] w-[40px] h-[40px] rounded-[20px] flex justify-center items-center bg-[#4866F626] text-[#4866F6] hover:bg-[#4866F6] hover:text-white cursor-pointer"
            >
            ...
            <div className="w-[70px] border-t border-[#CFCFCF] rotate-90 ml-[2px]"></div>
      ...
      "
        ...
        "
            ...
            <div className="hidden lg:flex flex-col">
              ...
              <p className="text-[14px] text-[#586D93]">Admin</p>
            </div>
      ...
      <div className="hidden md:flex justify-start items-center pl-4 lg:pl-5">
        <div className="w-[70px] lg:w-[330px] border-t border-[#CFCFCF]"></div>
      </div>
