    ...
    },
    {
      icon: (
        ...
        >
          ...
          />
          <path
            d="M0 14.565V22.065C0 25.5 2.775 28.275 6.21 28.275H23.775C27.21 28.275 30 25.485 30 22.05V14.565C30 13.56 29.19 12.75 28.185 12.75H1.815C0.81 12.75 0 13.56 0 14.565ZM9 23.25H6C5.385 23.25 4.875 22.74 4.875 22.125C4.875 21.51 5.385 21 6 21H9C9.615 21 10.125 21.51 10.125 22.125C10.125 22.74 9.615 23.25 9 23.25ZM18.75 23.25H12.75C12.135 23.25 11.625 22.74 11.625 22.125C11.625 21.51 12.135 21 12.75 21H18.75C19.365 21 19.875 21.51 19.875 22.125C19.875 22.74 19.365 23.25 18.75 23.25Z"
            fill="#4866F6"
          />
          <path
            d="M17.25 4.29059V8.68559C17.25 9.69059 16.44 10.5006 15.435 10.5006H1.815C0.795 10.5006 0 9.66059 0 8.65559C0.015 6.96059 0.69 5.41559 1.815 4.29059C2.94 3.16559 4.5 2.47559 6.21 2.47559H15.435C16.44 2.47559 17.25 3.28559 17.25 4.29059Z"
            fill="#4866F6"
          />
        </svg>
      ),
...
md:flex-row md:flex-nowrap md:items-center    lg:grid lg:grid-cols-2
  ...
  "
            >
              ...
              <div className="relative w-full md:w-[240px] lg:w-full xl:flex-1">
                ...
                <Search
                  size={22}
                  strokeWidth={1.8}
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-[#8D99AE]"
                />
              </div>
              ...
              <div className="relative w-full md:w-[180px] lg:w-full xl:w-[180px]">
                <select className="w-full h-[34px] border border-[#D9D9D9] rounded-[10px] px-4 appearance-none text-[14px] text-[#8D99AE] bg-white focus:outline-none">
              ...
              <div className="relative w-full md:w-[240px] lg:w-full xl:w-[220px]">
                <select className="w-full h-[34px] border border-[#D9D9D9] rounded-[10px] px-4 appearance-none text-[14px] text-[#8D99AE] bg-white focus:outline-none">
                  <option>Subscription Filter</option>
                </select>
              ...
              {/* Export */}
              <button className="w-full md:w-[100px] lg:w-full xl:w-[130px] h-[34px] whitespace-nowrap bg-[#4866F6] rounded-[8px] text-white text-[14px] font-medium flex items-center justify-center gap-2">
                Export
          ...
          <div className="mx-4 md:mx-5 lg:mx-7 mt-5 mb-8 border border-[#D9D9D9] rounded-[12px] overflow-hidden bg-white">
            <div className="overflow-x-auto custom-scrollbar">
              <table className="w-full min-w-[1000px]">
                <thead className="bg-[#F5F7FF] border-b-[2px] border-[#1695F9]">
                  <tr>
                    <th className="h-[62px] px-5 text-left text-[14px] font-medium text-[#3D3D3D]">
                      SL No
                    </th>
                    <th className="h-[62px] px-5 text-left text-[14px] font-medium text-[#3D3D3D]">
                      User Name
                    ...
                    <th className="h-[62px] px-5 text-center text-[14px] font-medium text-[#3D3D3D]">
                      Action
                    </th>
                  </tr>
                </thead>
                ...
                <tbody>
                  {paginatedRows.map((r) => (
                    <tr key={r.id} className="border-b border-[#E5E5E5]">
                      <td className="h-[52px] px-5 text-[14px] text-[#5A6B95]">
                        {r.id}
                      </td>
                      ...
                      <td className="h-[52px] px-5">
                        <span
                          className={`inline-flex items-center gap-2 px-4 h-[28px] rounded-full text-[14px] font-medium ${
                            r.status === "Success"
                      ...
                      <td className="h-[52px] px-5">
                        ...
                        >
                          ...
                          <svg
                            ...
                            xmlns="http://www.w3.org/2000/svg"
                          >
                            <g clipPath="url(#clip0_1258_1699)">
                              <mask
                                id="mask0_1258_1699"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-[2px] px-4">
          <div className="w-full max-w-[820px] bg-white rounded-[28px] border-2 border-[#1695F9] p-4 sm:p-6 relative">
            ...
            <button
              ...
              className="absolute top-5 right-5 w-[24px] h-[24px] rounded-full bg-[#EF4444] text-white flex items-center justify-center"
            >
              ×
            </button>
            ...
            <div className="mt-6 border border-[#4866F6] bg-[#EEF2FF] rounded-[16px] p-4 flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-between">
              ...
              <div className="text-left md:text-right">
                <p className="text-[16px] font-medium text-[#3D3D3D]">Amount</p>

                <p className="text-[14px] font-semibold text-[#8B97AC]">₹999</p>
              </div>
            </div>
            <div className="border-b border-[#D9D9D9] mt-5 mb-5"></div>
            <div className="flex items-end justify-between">
              ...
              <div className="flex-1">
                ...
                <span className="inline-flex items-center justify-center w-[105px] h-[33px] rounded-full bg-[#2FB55D] text-white text-[15px]">
                  Success
                </span>
              </div>
              ...
              <div className="flex-1 flex flex-col items-end">
                ...
                <button className="w-[135px] h-[35px] bg-[#4866F6] rounded-[8px] flex items-center justify-center gap-2 text-white text-[14px] font-medium">
                  Download
  ...
  return (
    <div className="flex justify-end items-center gap-4 md:gap-8 py-6 pr-4 md:pr-10 text-[14px] text-[#3D3D3D]">
      <button
        ...
        className="flex items-center gap-2 text-[#4866F6] disabled:text-gray-300"
      >
