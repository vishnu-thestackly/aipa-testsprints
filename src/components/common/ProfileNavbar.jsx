              ...
              <div className="flex items-center gap-2 overflow-x-auto no-scrollbar scroll-smooth w-full">
                ...
                {languages.map((item, index) => (
                  <button
                    ...
                    className={`flex-shrink-0 min-w-[90px] h-[36px] px-4 rounded-[35px] text-[13px] flex items-center justify-center whitespace-nowrap transition-all duration-300 ${selectedLang === item
