            ...
            <div className="flex flex-col items-center gap-3 pt-4 px-0 xl:px-3">
                  ...
                  <div className="flex items-center gap-[10px]">
                    <svg
                      className={`w-[20px] h-[20px] ${
                        activeItem === "tasks" ? "text-white" : "text-[#586D93]"
                    ...
                    <p
                      className={`hidden lg:block ${activeItem === "tasks" ? "text-white" : "text-[#586D93]"} group-hover:text-white`}
                    >
                      Tasks
                    </p>
                  </div>
              ...
              <div className="mt-2">
                ...
                >
                  ...
                  <svg
                    className={`hidden lg:block transition-all duration-300 ${openMenu.integrations ? "rotate-180" : ""}`}
                    width="18"
                    height="9"
                    viewBox="0 0 18 9"
                    fill="none"
              ...
              <div>
                ...
                >
                  ...
                  <svg
                    className={`hidden lg:block transition-all duration-300 ${openMenu.settings ? "rotate-180" : ""}`}
                    width="18"
                    height="9"
                    viewBox="0 0 18 9"
                    fill="none"
