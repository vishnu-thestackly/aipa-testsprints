...
const [tabletTasksOpen, setTabletTasksOpen] = useState(false);
const [tabletIntegrationsOpen, setTabletIntegrationsOpen] = useState(false);
const [tabletSettingsOpen, setTabletSettingsOpen] = useState(false);
return (
<div className="hidden md:block">


<div className='w-[115px] lg:w-[280px] xl:w-[375px] h-screen bg-white p-1 lg:p-4 overflow-y-auto no-scrollbar'>
  <div className='w-[100%] h-full flex flex-col items-center justify-between'>
<div>

<div className="flex-1 overflow-visible">{/* first icon */}
<div onClick={() => {
...
<p className={`hidden lg:block ${activeItem==="newchat" ? "text-white" : "text-[#586D93] group-hover:text-white"}`}>New Chat</p>
...
<div onClick={() => {
  ...
  setOpenMenu({
    ...openMenu,
    tasks: !openMenu.tasks,
  });
}}className={`w-[50px] lg:w-[220px] xl:w-[315px] h-[38px] flex justify-center lg:justify-between rounded-lg py-[6px] px-[6px] items-center mt-1 xl:mt-2 cursor-pointer group ${
  activeItem === "tasks"
    ? "bg-[#4866F6]"
    : "hover:bg-[#4866F6]"
}`}>
...
<svg
  className={`w-[20px] h-[20px] ${
    activeItem === "tasks"
      ? "text-white"
      : "text-[#586D93]"
  } group-hover:text-white`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
=======
  sidebarOpen,
  setSidebarOpen,
  profilePage,
...
const navigate = useNavigate();
const [openMenu, setOpenMenu] = useState({ tasks:false, integrations:false, settings:false});
useEffect(() => {
  const handleResize = () => {
    if (window.innerWidth < 1024) {
      setOpenMenu({
...
{/* Desktop Sidebar (lg+)   - Full sidebar  - Dropdown menus */}

<div className="flex flex-col items-center gap-3 pt-4 px-0 xl:px-3">
          <div onClick={() => {
  setActiveItem("newchat");
  if (window.innerWidth < 1024) {
    setSidebarOpen?.(true);
...
<div>
<div onClick={() => {
  setActiveItem("tasks");if (window.innerWidth < 1024) { setSidebarOpen?.(true);
  return;}
 setOpenMenu({   ...openMenu,   tasks: !openMenu.tasks, });
}}className={`w-[50px] lg:w-[220px] xl:w-[315px] h-[38px] flex justify-center lg:justify-between rounded-lg py-[6px] px-[6px] items-center mt-1 xl:mt-2 cursor-pointer group ${
  activeItem === "tasks"  ? "bg-[#4866F6]"  : "hover:bg-[#4866F6]"}`}>
<div className='flex items-center gap-[10px]'>
<svg
  className={`w-[20px] h-[20px] ${
    activeItem === "tasks"  ? "text-white"  : "text-[#586D93]"} group-hover:text-white`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
>>>>>>> d59cd9811fcdae9d277e123b337195690bf067c6
...
<p className={`hidden lg:block ${activeItem==="tasks" ? "text-white" : "text-[#586D93]"} group-hover:text-white`}>
...
{openMenu.tasks && (
  <div className='hidden lg:flex ml-[45px] mt-1 xl:mt-2 flex-col gap-3 min-[1024px]:gap-1 xl:gap-3'>
...
}}className={`w-[50px] lg:w-[220px] xl:w-[315px] h-[38px] flex justify-center lg:justify-between rounded-lg py-[6px] px-[6px] group items-center  cursor-pointer ${activeItem==="track" ? "bg-[#4866F6]" : "hover:bg-[#4866F6]"}`}>
<<<<<<< HEAD
...
<p className={`hidden lg:block ${activeItem==="track" ? "text-white" : "text-[#586D93]"} group-hover:text-white`}>
Integrations
</p>

</div>

<svg className={`hidden lg:block transition-all duration-300 ${openMenu.integrations ? "rotate-180" : ""}`} width="18" height="9" viewBox="0 0 18 9" fill="none">
...
{((window.innerWidth >= 1024 && openMenu.integrations) ||
  (window.innerWidth < 1024 && tabletIntegrationsOpen)) && (
<div className="hidden lg:flex ml-[40px] mt-1 xl:mt-2 flex-col gap-3 min-[1024px]:gap-1 xl:gap-3">
<div className="flex items-center gap-[10px] cursor-pointer">
...
<div>
<div onClick={() => { setActiveItem("communication"); if (window.innerWidth < 1024) { setSidebarOpen?.(true);
 return;
} 
 setOpenMenu({  ...openMenu,  settings: !openMenu.settings,});}} className={`w-[50px] lg:w-[220px] xl:w-[315px] h-[38px] flex justify-center lg:justify-between rounded-lg py-[6px] px-[6px] group items-center mt-2 cursor-pointer ${activeItem==="communication" ? "bg-[#4866F6]" : "hover:bg-[#4866F6]"}`}>
<div className='flex items-center gap-[10px]'>
>>>>>>> d59cd9811fcdae9d277e123b337195690bf067c6
...
<p className={`hidden lg:block ${activeItem==="communication" ? "text-white" : "text-[#586D93]"} group-hover:text-white`}>
Settings
</p>

</div>

<svg className={`hidden lg:block transition-all duration-300 ${openMenu.settings ? "rotate-180" : ""}`} width="18" height="9" viewBox="0 0 18 9" fill="none">
...
{openMenu.settings && window.innerWidth >= 1024 && (
  <div className="ml-[40px] mt-1 xl:mt-2 flex flex-col gap-3 min-[1024px]:gap-1 xl:gap-3">
<div className="ml-[40px] mt-1 xl:mt-2 flex flex-col gap-3 min-[1024px]:gap-1 xl:gap-3">
<div
  onClick={() => setActiveItem("preferenceSetting")}
  className={`flex items-center gap-[10px] cursor-pointer px-2 py-2 rounded-lg ${
...
className={`w-[50px] lg:w-[220px] xl:w-[315px] h-[38px] flex justify-center lg:justify-start gap-[6px] rounded-lg py-[6px] px-[10px] group items-center mt-2 cursor-pointer transition-all duration-300 ${activeItem==="profileDashboard" ||
activeItem==="subscriptionPlans" ? "bg-[#4866F6]" : "hover:bg-[#4866F6]"}`}
>

<svg className={`w-[20px] h-[20.73px] ${activeItem==="profileDashboard" ||
activeItem==="subscriptionPlans" ? "text-white" : "text-[#586D93]"} group-hover:text-white`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<p className={`hidden lg:block ${activeItem==="profileDashboard" ||
activeItem==="subscriptionPlans" ? "text-white" : "text-[#586D93]"} group-hover:text-white`}>
Profile
</p>
...
<button className='hidden md:flex lg:hidden w-[50px] h-[44px] rounded-[10px] border border-[#FB0000] bg-[#FF000033] items-center justify-center cursor-pointer' onClick={() => navigate("/login")}><img src="./src/assets/images/SignOut.png" alt="logout" className="w-[18px] h-[18px]" /></button>
{/* WEB VIEW - FULL BUTTON */}
<button className='hidden lg:flex w-[220px] xl:w-[315px] h-[44px] items-center justify-center gap-[10px] rounded-[10px] border border-[#FB0000] bg-[#FF000033] font-medium text-[18px] text-[#FF0000] cursor-pointer' onClick={() => navigate("/login")}><span>Logout</span><img src={SignOut} alt="logout" className="w-[18px] h-[18px]" /></button>
...
{showTabletMenu && (
  <>
    ...
    {/* Tablet Drawer */}
<div className="hidden md:block lg:hidden fixed left-0 top-0 h-screen w-[285px] bg-white z-50 shadow-xl overflow-y-auto no-scrollbar">
<div className="px-[14px] py-[10px] flex flex-col h-full">
        {/* Header */}
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-[10px]">
            <img
              src={logo}
              alt=""
              className="w-[38px] h-[32px] sm:w-[44px] sm:h-[38px]"
            />

            <div>
              <h2 className="font-bold text-[18px] text-[#4866F6] leading-[16px]">
                Personal
              </h2>
          ...
          <button
            onClick={() => setShowTabletMenu(false)}
            className="w-[40px] h-[40px] rounded-full flex items-center justify-center bg-[#4866F626] text-[#4866F6]"
          >
            ✕
          </button>
        </div>

        <div className="w-full border-t border-[#CFCFCF] mt-[12px] mb-[24px]" />
<div className="flex-1 overflow-y-auto no-scrollbar mt-[12px] pb-[80px]">
        {/* PASTE ALL MENU ITEMS HERE */}
...
<p className={`block text-[14px] ${activeItem==="newchat" ? "text-white" : "text-[#586D93] group-hover:text-white"}`}>New Chat</p>
  ...
  if (window.innerWidth < 1024) {
    setTabletTasksOpen(!tabletTasksOpen);
    return;
  }
...
> 
       ...
       {((window.innerWidth >= 1024 && openMenu.tasks) ||
  (window.innerWidth < 1024 && tabletTasksOpen)) && (
  ...
  if (window.innerWidth < 1024) {
    setTabletIntegrationsOpen(!tabletIntegrationsOpen);
    return;
  }
...
>
  ...
  if (window.innerWidth < 1024) {
    setTabletSettingsOpen(!tabletSettingsOpen);
    return;
  }
...
>
  ...
  />
       ...
       {((window.innerWidth >= 1024 && openMenu.settings) ||
  (window.innerWidth < 1024 && tabletSettingsOpen)) && (
       <div className="ml-[40px] mt-2 flex flex-col gap-[18px] mt-[14px]">
       ...
       <p className="text-[#586D93]">Notifications</p>
        ...
        {/* fifth icon */}
       <div onClick={() => setActiveItem("profileDashboard")} className={`w-full h-[42px] flex items-center justify-start gap-[12px] px-[14px] rounded-[8px] mt-[18px] cursor-pointer group transition-all duration-300 ${activeItem==="profileDashboard" ||
activeItem==="subscriptionPlans" ? "bg-[#4D63F3]" : "hover:bg-[#4866F6]"}`}>
       <svg className={`w-[20px] h-[20.73px] ${activeItem==="profileDashboard" ||
activeItem==="subscriptionPlans" ? "text-white" : "text-[#586D93]"} group-hover:text-white`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
       <mask id="mask0_1751_4346" style={{maskType:"luminance"}} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
       <path d="M24 0H0V24H24V0Z" fill="white"/>
       ...
       <p className={`text-[14px] font-medium ${activeItem==="profileDashboard" ||
activeItem==="subscriptionPlans" ? "text-white" : "text-[#586D93]"} group-hover:text-white`}>
       Profile
       </p>
  ...
  <button onClick={() => navigate("/login")} className="w-full h-[44px] flex items-center justify-center gap-[10px] rounded-[10px] border border-[#FB0000] bg-[#FF000033] text-[#FB0000] font-medium text-[14px] cursor-pointer">
    <span>Logout</span>
    <img
      src={SignOut}
      alt="logout"
...
<p className={`hidden lg:block ${activeItem==="communication" ? "text-white" : "text-[#586D93]"} group-hover:text-white`}>Settings</p>
</div>
<svg className={`hidden lg:block transition-all duration-300 ${openMenu.settings ? "rotate-180" : ""}`} width="18" height="9" viewBox="0 0 18 9" fill="none">
<path d="M16.59 0.75L10.07 7.27C9.30002 8.04 8.04002 8.04 7.27002 7.27L0.75 0.75" stroke={activeItem==="communication" ? "white" : "#586D93"} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg></div>
...
<svg className={`w-[20px] h-[20.73px] ${activeItem==="profileDashboard" || activeItem==="subscriptionPlans" ? "text-white" : "text-[#586D93]"} group-hover:text-white`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<mask id="mask0_1751_4346" style={{maskType:"luminance"}} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
<path d="M24 0H0V24H24V0Z" fill="white"/>
</mask>
<g mask="url(#mask0_1751_4346)">
...
<p className={`hidden lg:block ${activeItem==="profileDashboard" || activeItem==="subscriptionPlans" ? "text-white" : "text-[#586D93]"} group-hover:text-white`}> Profile </p>
</div>
{/* for logout button */}

<div className="mt-6 mb-5">
  <button
    className="hidden md:flex lg:hidden w-[50px] h-[44px] rounded-[10px] border border-[#FB0000] bg-[#FF000033] items-center justify-center"
    onClick={() => navigate("/")}
  >
  ...
  <button
    className="hidden lg:flex w-[220px] xl:w-[315px] h-[44px] items-center justify-center gap-[10px] rounded-[10px] border border-[#FB0000] bg-[#FF000033] text-[#FF0000]"
    onClick={() => navigate("/")}
  >
    <span>Logout</span>
    <img src={SignOut} alt="logout" className="w-[18px] h-[18px]" />
