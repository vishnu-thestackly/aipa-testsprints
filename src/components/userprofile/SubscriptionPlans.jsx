...
//   return (
//     <div className=" min-h-screen lg:h-[950px]  w-full bg-[#F6F7FA] md:h-[1150px] overflow-hidden">
//       <Navbar /> 
//       <Sidebar/>
      
      
//       <div className="pt-16 md:pt-5 lg:pt-8 p-2 sm:p-4 ">
        
// <div className="w-full md:ml-[105px] mt-[-50px] md:max-w-[calc(100%-80px)] md:mt-[-570px] lg:ml-[280px]
// xl:ml-[380px] lg:mr-[20px] lg:w-auto xl:w-auto lg:px-0 lg:mt-[-710px]">       
//   <div className="bg-white md:h-[950px] lg:h-[800px] rounded-2xl lg:rounded-3xl p-3 sm:p-5 md:p-6 lg:p-8 xl:p-12 shadow-sm border border-gray-100">
...
//                 <ArrowLeft onClick={() => navigate("/user-profile")}className="w-3 h-3 sm:w-4 sm:h-4 text-white" strokeWidth={2.5} />
//               </div>
