...
import { getUserProfile, verifyPayment, getSubscriptionDetails } from "../../api/authApi";
...
>
  ...
  />
                ...
                <div className="flex flex-col">
                  ...
                  <button
                    onClick={() => navigate("/user/profile/plans")}
                    className="mt-4 w-[200px] h-[42px] rounded-full bg-[#4866F6] text-white font-medium flex items-center justify-center gap-2 cursor-pointer hover:bg-[#3554ED] transition-all"
                  >
                    Upgrade Plan
