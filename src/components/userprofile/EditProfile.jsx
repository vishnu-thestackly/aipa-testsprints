...
//       }));
//     }}
//     onClick={(e) => e.target.showPicker()}   // Opens when input is clicked
//     className={input_style}
//   />
...
//     src={Calendar}
//     alt="calendar"
//     onClick={() => dateInputRef.current?.showPicker()}  // Opens when icon is clicked
...
>
            ...
            {/* BUTTONS */}
<div className="flex gap-3 justify-center ">
<button type="button" onClick={() => setProfilePage("dashboard")} className="px-6 h-11 lg:mt-[20px] text-[#4866F6] border border-[#4866F6] rounded-full">
