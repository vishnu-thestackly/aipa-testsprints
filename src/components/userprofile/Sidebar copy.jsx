...
<div className="flex-1 overflow-visible flex flex-col gap-3 pt-4 px-3">
        <div onClick={() => {
...
<div>
<div onClick={() => {
  setActiveItem("tasks");if (window.innerWidth < 1024) { setShowTabletMenu(true);
...
<div>
<div onClick={() => { setActiveItem("communication"); if (window.innerWidth < 1024) { setShowTabletMenu(true);
setSidebarOpen(true);
setSidebarOpen(true); return;} setOpenMenu({  ...openMenu,  settings: !openMenu.settings,});}} className={`w-[50px] lg:w-[220px] xl:w-[315px] h-[38px] flex justify-center lg:justify-between rounded-lg py-[6px] px-[6px] group items-center mt-2 cursor-pointer ${activeItem==="communication" ? "bg-[#4866F6]" : "hover:bg-[#4866F6]"}`}>
<div className='flex items-center gap-[10px]'>
...
<button className='hidden md:flex lg:hidden w-[50px] h-[44px] rounded-[10px] border border-[#FB0000] bg-[#FF000033] items-center justify-center cursor-pointer' onClick={() => navigate("/")}><img src="./src/assets/images/SignOut.png" alt="logout" className="w-[18px] h-[18px]" /></button>

{/* WEB VIEW - FULL BUTTON */}

<button className='hidden lg:flex w-[220px] xl:w-[315px] h-[44px] items-center justify-center gap-[10px] rounded-[10px] border border-[#FB0000] bg-[#FF000033] font-medium text-[18px] text-[#FF0000] cursor-pointer' onClick={() => navigate("/")}><span>Logout</span><img src="./src/assets/images/SignOut.png" alt="logout" className="w-[18px] h-[18px]" /></button>
</div>
...
{showTabletMenu && (
  <>
    ...
    {/* ------------------------ */}
    {/* MOBILE SIDEBAR */}
    <div className={`fixed top-0 left-0 h-screen w-[285px] bg-white z-50 shadow-lg transition-all duration-300 md:block lg:hidden overflow-y-auto no-scrollbar ${  sidebarOpen ? "translate-x-0" : "-translate-x-full"}`}>
...
>
  ...
  />
    ...
    <div onClick={() => setSidebarOpen(!sidebarOpen)} className="hidden md:flex lg:hidden absolute top-[22px] right-[20px] w-[40px] h-[40px] rounded-[20px] justify-center items-center bg-[#4866F626] text-[#4866F6] hover:bg-[#4866F6] hover:text-white cursor-pointer">
    ...
    {/* Horizontal Line */}
    <div className="hidden md:block lg:hidden w-full border-t border-[#CFCFCF] mt-[18px] mb-[12px]"></div>{/* mmobile sidebar */}
...
<div className="ml-[32px] mt-[6px] flex flex-col gap-[2px]">
  ...
  onClick={() => {
    setActiveItem("profileDashboard");
    setProfilePage("preferenceSetting");
